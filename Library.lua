...
local Library = { } do
    ...
    Library.ESPPreview = function(Self, Params)
        ...
        Items.Camera = Create("Camera", {
            ...
            CFrame = CFrame.lookAt(Vector3.new(0, 2.5, 4.3), Vector3.new(0, 0.65, 0))
        })
        ...
        local function UpdateBounds()
            ...
            Camera.CFrame = CFrame.lookAt(Target + Vector3.new(0, 0.25, 4.3), Target)
        ...
        function Preview:Refresh()
            ...
            local WeaponTag = Flags["ESP Weapon Tag"] and true or false
            ...
            local WeaponColor, WeaponAlpha = Color("ESP Weapon Tag Color", Color3.new(1, 1, 1))
            ...
            Items.FillGradient.Instance.Transparency = NumberSequence.new({
                NumberSequenceKeypoint.new(0, FillHighAlpha),
                NumberSequenceKeypoint.new(1, FillLowAlpha)
            })
            Items.FillGradient.Instance.Rotation = Flags["ESP Box Fill Rotation"] or 0
            ...
            Items.GlowGradient.Instance.Rotation = Flags["ESP Box Glow Rotation"] or 0
